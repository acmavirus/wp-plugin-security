        ...
        <h2><?php _e('Trình soạn thảo cổ điển & TinyMCE', 'acma-security-shield'); ?></h2>
                        <div class="wps-grid two">
                            <div class="wps-card">
        <h4><?php _e('Chế độ soạn thảo', 'acma-security-shield'); ?></h4>
        ...
        <?php $this->render_checkbox_row('enable_tinymce_advanced', 'TinyMCE nâng cao', $main_settings, 'Mở rộng các nút font, code, màu sắc và table.'); ?>
                            ...
                            <div class="wps-card">
        <h4><?php _e('Ghi chú', 'acma-security-shield'); ?></h4>
        <p><?php _e('Các nút TinyMCE được controller mới thêm vào editor khi tùy chọn này được bật.', 'acma-security-shield'); ?></p>
                            </div>
                        </div>

                        <input type="hidden" name="wps_save_settings" value="1">
        <?php submit_button(__('Lưu thiết lập Editor', 'acma-security-shield')); ?>
                    </form>
