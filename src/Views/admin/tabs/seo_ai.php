        ...
        <h2><?php _e('SEO AI + Rank Math', 'acma-security-shield'); ?></h2>
                        <div class="wps-grid two">
                            <div class="wps-card">
                                <h4><?php _e('Tự động tối ưu', 'acma-security-shield'); ?></h4>
                                <table class="form-table wps-form-table" role="presentation">
                                    ...
                                    <tr>
                                        <th scope="row"><label for="seo_ai_brand_name"><?php _e('Tên thương hiệu', 'acma-security-shield'); ?></label></th>
                            ...
                            <div class="wps-card">
                                ...
                                <p><?php _e('Khi lưu bài viết, module sẽ tạo focus keyword, SEO title, meta description và đồng bộ vào meta của Rank Math.', 'acma-security-shield'); ?></p>
                                <p><?php _e('Điểm SEO AI ước tính chỉ là checklist nội bộ. Điểm thật của Rank Math vẫn phụ thuộc vào nội dung và test của plugin đó.', 'acma-security-shield'); ?></p>
                            </div>
                            <div class="wps-card">
                                <h4><?php _e('Gemini API', 'acma-security-shield'); ?></h4>
                                <table class="form-table wps-form-table" role="presentation">
                                    ...
                                    <tr>
                                        <th scope="row"><label for="seo_ai_gemini_api_key"><?php _e('Gemini API key', 'acma-security-shield'); ?></label></th>
                                    ...
                                    <tr>
                                        <th scope="row"><label for="seo_ai_gemini_model"><?php _e('Model', 'acma-security-shield'); ?></label></th>
                                    ...
                                    <tr>
                                        <th scope="row"><label for="seo_ai_gemini_temperature"><?php _e('Temperature', 'acma-security-shield'); ?></label></th>
                                    ...
                                    <tr>
                                        <th scope="row"><label for="seo_ai_gemini_prompt"><?php _e('Prompt mẫu', 'acma-security-shield'); ?></label></th>
                                        <td>
                                            ...
                                            <p class="description"><?php _e('Để trống để dùng prompt tối ưu SEO mặc định của plugin. Hỗ trợ placeholder {title}, {content}, {brand}, {post_type}.', 'acma-security-shield'); ?></p>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                ...
                <div class="wps-card" style="margin-top: 20px;">
                    ...
                    <p class="description"><?php _e('Chạy quét hàng loạt để tạo SEO title, description và Rank Math meta cho các bài viết đã tồn tại.', 'acma-security-shield'); ?></p>
                            <p>
                                <button type="button" class="button button-secondary" id="wps-seo-ai-bulk-scan" data-nonce="<?php echo esc_attr(wp_create_nonce('wps_seo_ai_bulk_scan')); ?>"><?php _e('Quét và tối ưu toàn bộ bài viết', 'acma-security-shield'); ?></button>
                            ...
                            <div style="margin-top: 14px;">
                                ...
                                <div id="wps-seo-ai-bulk-progress-text" class="description" style="margin-top: 8px;"><?php _e('Chưa bắt đầu quét.', 'acma-security-shield'); ?></div>
                            </div>
                        ...
                        (function(){
                            ...
                            async function runQueue(items) {
                                ...
                                if (!total) {
                                    ...
                                    button.textContent = '<?php echo esc_js(__('Quét và tối ưu toàn bộ bài viết', 'acma-security-shield')); ?>';
                                    return;
                                }
                        ...
                        <?php submit_button(__('Lưu thiết lập SEO AI', 'acma-security-shield')); ?>
                    </form>
